...
<!DOCTYPE html>
<!-- saved from url=(0076)file:///C:/Users/Jamos/Desktop/ACC/Starter%20Template%20for%20Bootstrap.html -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		...
		<link href="./Template_files/bootstrap-theme.css" rel="stylesheet">
		...
		<link href='./Template_files/filedrop.css' rel='stylesheet'>
		<script src="http://code.jquery.com/jquery-1.11.0.min.js"></script>
		
	</head>
	<script src="./Template_files/app.js"></script>

	<body>
<s:textfield name="jsonObj" id="jsonObj" value="%{jsonObj}"
 	   type="hidden" />
		...
		<form>
<s:form action="UploadFiles" namespace="/"
method="POST" enctype="multipart/form-data">

<s:file name="imgFile" id="imgFile" label="Select a File to upload" size="40" />

<s:submit value="submit" name="esubmit" />
			...
			<div class="likes-container">
				<h2>Expected likes: <span class="likes">0</span></h2>
			</div>
		...
		<script src="./Template_files/filedrop-min.js"></script>
